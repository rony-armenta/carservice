...
// Minimal SVG icons — 16x16 stroke-based
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', padding: '0 4px' }}>
        ...
        <button
          ...
          style={{
            width: 30, height: 30, borderRadius: 6, border: '0.5px solid rgba(0,0,0,0.12)',
            background: 'transparent', cursor: 'pointer',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0, color: '#6b6b68',
      ...
      <button
        ...
        style={{
          ...
          color: '#6b6b68', cursor: 'pointer', fontSize: 13,
      ...
      <div style={{ marginTop: '0.5rem' }}>
        ...
        <button
          ...
          style={{
            ...
            width: '100%', padding: '8px 12px', borderRadius: 8,
            border: 'none', background: 'transparent',
            color: '#A32D2D', cursor: 'pointer', fontSize: 13,
            textAlign: 'left', fontFamily: 'inherit',
            transition: 'background 0.15s',
          }}
        >
